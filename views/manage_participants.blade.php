				...
				<div class="panel-body">							
					<table class="table table-hover">
						...
						<tr>
							<td>id</td>
							<td>name</td>
							<td>{{Form::text('deposit',$user->userTrip->deposit,['class'=>'form-control'])}}</td>
							<td>{{Form::text('leader_award',$user->userTrip->leader_award, ['class'=>'form-control'])}}</td>
							<td>{{Form::text('catholic_award',$user->userTrip->catholic_award,['class'=>'form-control'])}}</td>
							<td>{{Form::text('scholarship_award',$user->userTrip->scholarship_award,['class'=>'form-control'])}}</td>
							<td>{{Form::text('payment_amount',0,['class'=>'form-control'])}}</td>
							<td>{{Form::text('payment_date',0,['class'=>'form-control'])}}</td>
							<td>{{$user->userTrip->total_due}}</td>
							<td>{{Form::submit('save')}}</td>
						</form>
					</tr>
					@endforeach
